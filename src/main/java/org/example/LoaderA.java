 ...
 */
public class LoaderA {

    private static LoaderA.Exception loadingException = null;

    public static void tryLoad() throws LoaderA.Exception {
        ...
        if (loadingException != null) {
            ...
            try {
                ...
                throw loadingException = new Exception("Failed to load " + LoaderA.class, t);
            }
        }
    }
